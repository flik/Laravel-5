...
@section('header')
    ...
    <ol class="breadcrumb">
        ...
        @if ( Request::input('q') )
            ...
            <li class="active"><a href="{{ route('tasks.index') }}">Task</a></li>
    ...
    <div class="page-header clearfix">
        <h1>
            <i class="glyphicon glyphicon-align-justify"></i> Task
        ...
        <div class="panel panel-default">
            ...
            <div aria-labelledby="headingOne" role="tabpanel" class="panel-collapse collapse" id="collapseOne">
                <div class="panel-body">
                    <form class="Task_search" id="search" action="{{ route('tasks.index') }}" accept-charset="UTF-8" method="get">
                        ...
                        <div class="form-horizontal">
                                ...
                                <label class="col-sm-2 control-label" for="q_projects.name_gt">PROJECT_NAME</label>
                                <div class=" col-sm-4">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['projects.name_gt']) ?: '' }}" name="q[projects.name_gt]" id="q_projects.name_gt" />
                                </div>
                                <div class=" col-sm-1 text-center"> - </div>
                                <div class=" col-sm-4">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['projects.name_lt']) ?: '' }}" name="q[projects.name_lt]" id="q_projects.name_lt" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="q_projects.name_cont">PROJECT_NAME</label>
                                <div class=" col-sm-9">
                                    <input class="form-control input-sm" type="search" value="{{ @(Request::input('q')['projects.name_cont']) ?: '' }}" name="q[projects.name_cont]" id="q_projects.name_cont" />
                                </div>
                            </div>
                                                    <div class="form-group">
            ...
            @if($tasks->count())
                <table class="table table-condensed table-striped">
                    <thead>
                        ...
                        <th>@include('CrudDscaffold::getOrderlink', ['column' => 'projects.name', 'title' => 'PROJECT_NAME'])</th>
                    ...
                    <td>{{$task->description}}</td>
                                <td class="text-right">
                                    <a class="btn btn-xs btn-primary" href="{{ route('tasks.duplicate', $task->id) }}"><i class="glyphicon glyphicon-duplicate"></i> Duplicate</a>
